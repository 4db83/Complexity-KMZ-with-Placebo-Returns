function [] = KMZ_GW_benchmark_function_placebo_Ret(trnwin,stdize,demean,save_path,placebo_seed)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% save_path = strcat('./tryrff_v2_SeparateSims/'); ORGINIAL NAME better to use
% save_path = './Step1_Predictions/';
