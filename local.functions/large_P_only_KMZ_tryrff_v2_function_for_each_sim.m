function [] = large_P_only_KMZ_tryrff_v2_function_for_each_sim(gamma, trnwin, iSim, stdize, demean, stdize_RFFs, OUT_DIR_NAME)
...
% Plist   = [2:2:12 24:12:(9*12) 12*(10:10:100) 1500:500:4000 5000 6000:2000:12000]; 46This was used % in the first submission paper
% Plist = [2:2:22 24:12:(9*12) 12*(10:10:100) 1500 2e3:2e3:12e3];           % 36 too fine ... 
% Plist = [2:2:12 24:12:(9*12) 12*(10:10:100) 1500:500:8e3 9e3:1e3:12e3];     % 42 finer grid with  

if trnwin == 60 
  Plist =  60*[300 500 800 1000];
elseif trnwin == 120
  Plist = 120*[200 300 500 800 1000];
else
  error("This is only for large P and trnwin 60 and 120")
end
