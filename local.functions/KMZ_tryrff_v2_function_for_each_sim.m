function [] = KMZ_tryrff_v2_function_for_each_sim(gamma, trnwin, iSim, stdize, demean, OUT_DIR_NAME, Plist, lamlist)
...
if SAVEON==1    
    if iSim == 1
        ...
        save([save_path '/iSim' num2str(iSim) '.mat'], 'Yprd','Bnrm','T','nP','nL','Y','dates','lamlist','Plist','gamma','stdize','iSim','maxP','nSim');
    else 
